    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return GetBuilder<AppController>(
          builder: (controller) {
            final isCompleted =
                controller.isStepCompleted(scholarship.id, step.type);
            ...
            return _RoadmapStepTile(
              ...
              isLast: isLast,
              onToggle: () =>
                  controller.toggleRoadmapStep(scholarship.id, step.type),
  ...
  void _handleAction(String route) {
    if (route == '/academy') {
      ...
      Get.snackbar('Consultation', 'Redirection vers l\'expert KPB...',
          backgroundColor: KpbColors.stitchDeepPurple, colorText: Colors.white);
    }
  }
}
