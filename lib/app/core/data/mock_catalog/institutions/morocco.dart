...
const kInstitutionsMorocco = <InstitutionModel>[
  InstitutionModel(
    id: 'ismagi',
  ...
  InstitutionModel(
    ...
    tuitionLabel: LocalizedText(fr: 'MAD 600–2 000/an', en: 'MAD 600–2 000/yr'),
    languageRequirements:
        LocalizedText(fr: 'Français (B2) / Arabe', en: 'French (B2) / Arabic'),
  ...
  InstitutionModel(
    ...
    tuitionLabel:
        LocalizedText(fr: 'MAD 85 000–110 000/an', en: 'MAD 85 000–110 000/yr'),
    languageRequirements: LocalizedText(
        fr: 'Français / Anglais (B2+)', en: 'French / English (B2+)'),
    intakePeriods: ['Septembre'],
  ...
  InstitutionModel(
    id: 'ege_rabat',
    name: LocalizedText(
        fr: 'EGE Rabat - École de Gouvernance et d\'Économie', en: 'EGE Rabat'),
    countryId: 'morocco',
    location: LocalizedText(fr: 'Rabat', en: 'Rabat'),
    overview: LocalizedText(
  ...
  InstitutionModel(
    id: 'upf_fes',
    name: LocalizedText(
        fr: 'Université Privée de Fès (UPF)', en: 'Private University of Fez'),
    countryId: 'morocco',
  ...
  InstitutionModel(
      ...
      name: LocalizedText(fr: 'Centrale Casablanca', en: 'Centrale Casablanca'),
      countryId: 'morocco',
