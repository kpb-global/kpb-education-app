...
const kInstitutionsFrance = <InstitutionModel>[
  InstitutionModel(
    id: 'icn',
    ...
    overview: LocalizedText(
        fr: 'ICN Business School — France', en: 'ICN Business School — France'),
  ...
  InstitutionModel(
    ...
    countryId: 'france',
    location:
        LocalizedText(fr: 'Toulouse, Paris, Lyon', en: 'Toulouse, Paris, Lyon'),
    overview:
        LocalizedText(fr: 'IGS - IGS-RH — France', en: 'IGS - IGS-RH — France'),
    studyLevels: ['Bac+3 / Bac+5'],
  ...
  InstitutionModel(
    ...
    countryId: 'france',
    location:
        LocalizedText(fr: 'Paris, Lyon, Toulouse', en: 'Paris, Lyon, Toulouse'),
    overview:
  ...
  InstitutionModel(
    ...
    location:
        LocalizedText(fr: 'Toulouse, Paris, Lyon', en: 'Toulouse, Paris, Lyon'),
    overview: LocalizedText(fr: 'IGS - IPI — France', en: 'IGS - IPI — France'),
    studyLevels: ['Bac+3 / Bac+5'],
    tuitionLabel: LocalizedText(
        fr: 'Entre 8000€ et 12000€/an', en: 'Entre 8000€ et 12000€/an'),
    languageRequirements: LocalizedText(fr: 'Français', en: 'French'),
  ...
  InstitutionModel(
    ...
    tuitionLabel: LocalizedText(fr: '170–3 770 EUR/an', en: '170–3 770 EUR/yr'),
  ...
  InstitutionModel(
    id: 'essec',
    name:
        LocalizedText(fr: 'ESSEC Business School', en: 'ESSEC Business School'),
    countryId: 'france',
  ...
  InstitutionModel(
    id: 'grenoble_em',
    name: LocalizedText(
        fr: 'Grenoble École de Management', en: 'Grenoble École de Management'),
    countryId: 'france',
  ...
  InstitutionModel(
    ...
    tuitionLabel: LocalizedText(fr: '600–3 770 EUR/an', en: '600–3 770 EUR/yr'),
    languageRequirements: LocalizedText(
  ...
  InstitutionModel(
    id: 'skema',
    name:
        LocalizedText(fr: 'SKEMA Business School', en: 'SKEMA Business School'),
    countryId: 'france',
    location: LocalizedText(
  ...
  InstitutionModel(
    id: 'edhec',
    name:
        LocalizedText(fr: 'EDHEC Business School', en: 'EDHEC Business School'),
    countryId: 'france',
    location:
  ...
  InstitutionModel(
    ...
    countryId: 'france',
    location: LocalizedText(
        fr: "Paris (Kremlin-Bicêtre)", en: "Paris (Kremlin-Bicêtre)"),
    overview: LocalizedText(
    ...
    studyLevels: ['Bac+3', 'Bac+5'],
    tuitionLabel:
        LocalizedText(fr: "8 500–10 900 EUR/an", en: "8,500–10,900 EUR/yr"),
    languageRequirements:
        LocalizedText(fr: "Français / Anglais", en: "French / English"),
  ...
  InstitutionModel(
    ...
    countryId: 'france',
    location: LocalizedText(
        fr: "Valenciennes / Montréal", en: "Valenciennes / Montreal"),
    overview: LocalizedText(
    ...
    studyLevels: ['Bac+3', 'Bac+5'],
    tuitionLabel:
        LocalizedText(fr: "9 200–11 500 EUR/an", en: "9,200–11,500 EUR/yr"),
    languageRequirements: LocalizedText(
        fr: "Français (portfolio requis)", en: "French (portfolio required)"),
    intakePeriods: ['Septembre'],
  ...
  InstitutionModel(
    id: 'isg_paris',
    name: LocalizedText(
        fr: "ISG International Business School",
        en: "ISG International Business School"),
    countryId: 'france',
    location: LocalizedText(fr: "Paris", en: "Paris"),
    overview: LocalizedText(
    ...
    studyLevels: ['Bac+3', 'Bac+5'],
    tuitionLabel:
        LocalizedText(fr: "9 800–12 500 EUR/an", en: "9,800–12,500 EUR/yr"),
    languageRequirements:
        LocalizedText(fr: "Français / Anglais", en: "French / English"),
    intakePeriods: ['Septembre', 'Janvier'],
  ...
  InstitutionModel(
    id: 'neoma',
    name:
        LocalizedText(fr: 'NEOMA Business School', en: 'NEOMA Business School'),
    countryId: 'france',
    location:
        LocalizedText(fr: 'Reims / Rouen / Paris', en: 'Reims / Rouen / Paris'),
    overview: LocalizedText(
  ...
  InstitutionModel(
    id: 'kedge',
    name:
        LocalizedText(fr: 'KEDGE Business School', en: 'KEDGE Business School'),
    countryId: 'france',
    location: LocalizedText(
        fr: 'Marseille / Bordeaux / Paris', en: 'Marseille / Bordeaux / Paris'),
    overview: LocalizedText(
  ...
  InstitutionModel(
    ...
    tuitionLabel:
        LocalizedText(fr: '15 000–25 000 EUR/an', en: '15 000–25 000 EUR/yr'),
    languageRequirements: LocalizedText(fr: 'Anglais (C1)', en: 'English (C1)'),
    intakePeriods: ['Septembre'],
  ...
  InstitutionModel(
    id: 'em_normandie',
    name: LocalizedText(
        fr: 'EM Normandie Business School', en: 'EM Normandie Business School'),
    countryId: 'france',
    location: LocalizedText(
  ...
  InstitutionModel(
      id: 'escp_paris',
      name:
          LocalizedText(fr: 'ESCP Business School', en: 'ESCP Business School'),
      countryId: 'france',
      location: LocalizedText(fr: 'Paris', en: 'Paris'),
      overview: LocalizedText(
  ...
  InstitutionModel(
      ...
      location: LocalizedText(fr: 'Lyon', en: 'Lyon'),
      overview: LocalizedText(
          fr: 'École de management prestigieuse. Focus sur l\'entrepreneuriat.',
  ...
  InstitutionModel(
      ...
      studyLevels: ['Bachelor', 'Master'],
      tuitionLabel: LocalizedText(fr: 'Public / Privé', en: 'Public / Private'),
      languageRequirements: LocalizedText(fr: 'Français', en: 'French'),
      intakePeriods: ['Septembre'],
  ...
  InstitutionModel(
      id: 'esce_paris',
      name: LocalizedText(fr: 'ESCE International Business School', en: 'ESCE'),
      countryId: 'france',
      location: LocalizedText(fr: 'Paris', en: 'Paris'),
      overview: LocalizedText(
  ...
  InstitutionModel(
      ...
      countryId: 'france',
      location:
          LocalizedText(fr: 'Paris / Lyon / Lille', en: 'Paris / Lyon / Lille'),
      overview: LocalizedText(
  ...
  InstitutionModel(
      ...
      countryId: 'france',
      location:
          LocalizedText(fr: 'Paris / Ivry / Laval', en: 'Paris / Ivry / Laval'),
      overview: LocalizedText(
  ...
  InstitutionModel(
      id: 'kedge_dakar',
      name: LocalizedText(fr: 'KEDGE Business School Dakar', en: 'KEDGE Dakar'),
      countryId: 'france',
  ...
  InstitutionModel(
      ...
      overview: LocalizedText(
          fr: 'Nouveau campus ISC en région.', en: 'New regional ISC campus.'),
      studyLevels: ['Bachelor', 'Master'],
      tuitionLabel: LocalizedText(fr: '9 000 EUR/an', en: '9 000 EUR/yr'),
      languageRequirements: LocalizedText(fr: 'Français', en: 'French'),
      intakePeriods: ['Septembre'],
