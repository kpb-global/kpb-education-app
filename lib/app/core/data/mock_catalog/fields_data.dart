...
const kFields = <FieldModel>[
  ...
  FieldModel(
    ...
    subjects: [
      ...
      LocalizedText(fr: 'Mathématiques', en: 'Mathematics'),
      LocalizedText(fr: 'Physique', en: 'Physics'),
      LocalizedText(fr: 'Mécanique des structures', en: 'Structural Mechanics'),
    ...
    careers: [
      ...
      LocalizedText(
          fr: 'Administrations publiques', en: 'Public administrations'),
      LocalizedText(fr: 'Industries électriques', en: 'Electrical industries'),
  ...
  FieldModel(
    ...
    subjects: [
      ...
      LocalizedText(fr: 'histoire…).', en: 'history…).'),
      LocalizedText(
          fr: 'Pratique artistique : dessin', en: 'Artistic practice: drawing'),
  ...
  FieldModel(
    ...
    careers: [
      LocalizedText(
          fr: 'Administrations publiques', en: 'Public administrations'),
      LocalizedText(fr: 'Collectivités territoriales', en: 'Local authorities'),
  ...
  FieldModel(
    ...
    subjects: [
      ...
      LocalizedText(fr: 'Histoire-géographie', en: 'History and Geography'),
      LocalizedText(
          fr: 'Technologie de la construction', en: 'Construction Technology'),
    ...
    careers: [
      ...
      LocalizedText(
          fr: 'Bâtiment (construction neuve', en: 'Building (new construction'),
  ...
  FieldModel(
    ...
    iaResilience: 'medium',
    name: LocalizedText(
        fr: 'Hôtellerie, Tourisme & Luxe', en: 'Hospitality, Tourism & Luxury'),
    description: LocalizedText(
